      ...
      {showNewForm && (
        <div onClick={() => setShowNewForm(false)} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000, padding: 16 }}>
          <div onClick={e => e.stopPropagation()} style={{ background: "#fff", borderRadius: 20, maxWidth: 480, width: "100%", padding: 28 }}>
            ...
            <input value={newCompany} onChange={e => setNewCompany(e.target.value)} onKeyDown={e => e.key === "Enter" && handleAddCompany()} placeholder="公司名称 *" autoFocus style={{ width: "100%", padding: "12px 14px", borderRadius: 10, border: `2px solid ${colors.border}`, fontSize: 15, outline: "none", boxSizing: "border-box", fontFamily: FONT, marginBottom: 12 }} />
            <input value={newUen} onChange={e => setNewUen(e.target.value)} onKeyDown={e => e.key === "Enter" && handleAddCompany()} placeholder="UEN（选填）" style={{ width: "100%", padding: "12px 14px", borderRadius: 10, border: `2px solid ${colors.border}`, fontSize: 15, outline: "none", boxSizing: "border-box", fontFamily: FONT, marginBottom: 20 }} />
        ...
        <div onClick={() => setShowNewForm(false)} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000, padding: 16 }}>
          <div onClick={e => e.stopPropagation()} style={{ background: "#fff", borderRadius: 20, maxWidth: 480, width: "100%", padding: 28 }}>
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              <input value={newCompany} onChange={e => setNewCompany(e.target.value)} onKeyDown={e => e.key === "Enter" && handleAddCompany()} placeholder="例: RICH INTERNATIONAL BUSINESS CONSULTING PTE. LTD." autoFocus
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <input value={newUen} onChange={e => setNewUen(e.target.value)} onKeyDown={e => e.key === "Enter" && handleAddCompany()} placeholder="例: 202609584R"
                style={{ width: "100%", padding: "12px 14px", borderRadius: 10, border: `2px solid ${colors.border}`, fontSize: 15, outline: "none", boxSizing: "border-box", fontFamily: FONT }}
                onFocus={e => (e.target.style.borderColor = "#0C0A09")} onBlur={e => (e.target.style.borderColor = colors.border)} />
            </div>
            <div style={{ display: "flex", gap: 10, justifyContent: "flex-end" }}>
